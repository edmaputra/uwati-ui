        ...
        <div>
          ...
          <nav class="space-y-1">
            ...
            <a
              ...
              routerLinkActive="bg-sky-50 text-sky-800 shadow-xs active-route"
              [routerLinkActiveOptions]="{ exact: true }"
              (click)="state.setTab('dashboard')"
              class="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-semibold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition-all cursor-pointer text-left"
            >
            ...
            <a
              routerLink="/triage"
              routerLinkActive="bg-rose-50 text-rose-800 shadow-xs active-route"
